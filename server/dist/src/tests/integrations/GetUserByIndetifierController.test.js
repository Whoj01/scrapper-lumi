...
describe("Prisma get user by identifier controller suit Test", () => {
    ...
    it("Given a valid search should return users", async () => {
        ...
        const mockGetUserByIdentifierRepository = {
            findUser: vi.fn().mockReturnValue([instanceUser]),
        };
        //atuar
        const users = await new GetUserByIdentifierController(mockGetUserByIdentifierRepository).handle({ params: mockedSearch });
        //afirmar
        expect(users).toEqual(mockedReturn);
        expect(mockGetUserByIdentifierRepository.findUser).toHaveBeenCalledWith(mockedSearch);
    ...
    it("Not given a search but the response is false should return error request", async () => {
        ...
        expect(mockGetUserByIdentifierRepository.findUser).toHaveReturnedWith(false);
    ...
    it("Given a valid search but no users found should return empty array", async () => {
        ...
        //atuar
        const users = await new GetUserByIdentifierController(mockGetUserByIdentifierRepository).handle({ params: null });
        //afirmar
        expect(users).toEqual(mockedReturn);
        expect(mockGetUserByIdentifierRepository.findUser).toHaveBeenCalledWith();
    ...
    it("should return error response if getBills throws", async () => {
        ...
        const GetUserByIdentifierControllerMock = new GetUserByIdentifierController(mockGetUserByIdentifierRepository);
